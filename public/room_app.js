//if (gameState.currentTurnPlayerId !== lastTurnPlayerId || gameState.currentPhase !== lastPhase) {(function() {
  ...
  const CARD_DICT = {
    ...
    'THUNDER_ATTACK': { name: 'สายฟ้าโจมตี (Thunder Attack)', desc: 'โจมตีด้วยดาเมจสายฟ้า — ทะลุ Rattan Armor และชาร์จสายโซ่', icon: '⚡', theme: 'card-slash', pic: null },
    'SIX_SWORDS_WU': { name: 'ดาบหกเหล่าอู๋ (Six Swords of Wu)', desc: 'อาวุธระยะ 2', icon: '⚔️', theme: 'card-weapon', pic: null },
    'FERGANA_STEED': { name: 'ม้าเฟอร์กาน่า (Fergana Steed)', desc: 'ม้าบุก (-1): ลดระยะห่างการโจมตีลง 1', icon: '🐎', theme: 'card-weapon', pic: null },
    'SHADOWRUNNER': { name: 'ม้าเงา (Shadowrunner)', desc: 'ม้าหมอบ (+1): เพิ่มระยะป้องกันขึ้น 1', icon: '🌑', theme: 'card-weapon', pic: null },
    'KIRIN_BOW': { name: 'ธนูกิเลน (Kirin Bow)', desc: 'อาวุธระยะ 5: เมื่อโจมตีติด ทำลายม้าของเป้าหมาย', icon: '🏹', theme: 'card-weapon', pic: null },
    'FEATHERED_FAN': { name: 'พัดขนนก (Feathered Fan)', desc: 'อาวุธระยะ 4: SLASH ทำดาเมจไฟ (FIRE)', icon: '🪶', theme: 'card-weapon', pic: null },
    'SERPENT_SPEAR': { name: 'หอกงู (Serpent Spear)', desc: 'อาวุธระยะ 3: ทิ้ง 2 ใบแทน SLASH โจมตีเป้าหมายได้', icon: '🐍', theme: 'card-weapon', pic: null },
    'FROST_SWORD': { name: 'ดาบน้ำแข็ง (Frost Sword)', desc: 'อาวุธระยะ 2: เมื่อโจมตีสำเร็จ สามารถเลือกไม่ทำดาเมจ แต่ให้เป้าหมายทิ้ง 2 ใบแทน', icon: '❄️', theme: 'card-weapon', pic: null },
    'TWO_BLADED_TRIDENT': { name: 'ง้าวสองง่าม (Two-bladed Trident)', desc: 'อาวุธระยะ 3: เมื่อถูกหลบ สามารถทิ้งการ์ดในมือ 1 ใบเพื่อบังคับให้โจมตีต่อ', icon: '🔱', theme: 'card-weapon', pic: null },
    'ROCK_CLEAVING_AXE': { name: 'ขวานผ่าหิน (Rock Cleaving Axe)', desc: 'อาวุธระยะ 3: เมื่อถูกหลบ สามารถทิ้ง 2 ใบ (มือ/อุปกรณ์) เพื่อบังคับให้โจมตีต่อ', icon: '🪓', theme: 'card-weapon', pic: null },
    'GREEN_DRAGON_BLADE': { name: 'ง้าวมังกรเขียว (Green Dragon Blade)', desc: 'อาวุธระยะ 3: เมื่อถูกหลบ สามารถออก SLASH ใส่เป้าหมายเดิมได้เรื่อยๆ', icon: '🐉', theme: 'card-weapon', pic: null },
    'SKY_PIERCING_HALBERD': { name: 'ทวนกรีดฟ้า (Sky Piercing Halberd)', desc: 'อาวุธระยะ 4: หากใช้ SLASH เป็นใบสุดท้ายในมือ จะเลือกเป้าหมายได้ 3 คน', icon: '⚔️', theme: 'card-weapon', pic: null },
  };
